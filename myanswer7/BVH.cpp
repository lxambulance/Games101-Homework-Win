...
Intersection BVHAccel::getIntersection(BVHBuildNode* node,
    ...
    if (node->object) {
        ...
        auto I1 = getIntersection(node->left, ray);
        auto I2 = getIntersection(node->right, ray);
        result = (I1.distance < I2.distance ? I1 : I2);
    }
...
void BVHAccel::Sample(Intersection& pos, float& pdf) {
    float p = std::sqrt(get_random_float()) * root->area;  // why use sqrt?
